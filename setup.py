...
setup(
  ...
  packages=['copaco', 'copaco.models', 'copaco.constants', 'copaco.cache', 'copaco.endpoints'],
  version = '0.1.3',
  ...
  download_url = 'https://github.com/alexanderlhsglobal/python-copaco-connections/archive/refs/tags/0.1.1.tar.gz',
